        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalChargesDescription = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    Notes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotalWithTax = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Area", "CreatedAt", "Description", "Floor", "HasAirConditioning", "HasPrivateBathroom", "IsFurnished", "MonthlyRent", "RoomNumber", "Status", "Type", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, 25.5m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cozy single room with city view", 1, true, true, false, 800.00m, "101", 1, 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, 35.0m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Spacious double room with balcony", 1, true, true, true, 1200.00m, "102", 1, 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, 55.0m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Luxury suite with separate living area", 2, true, true, true, 1800.00m, "201", 3, 4, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                filter: "\"ReferenceNumber\" IS NOT NULL AND \"ReferenceNumber\" != ''");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"IdentificationNumber\" IS NOT NULL AND \"IdentificationNumber\" != ''");
