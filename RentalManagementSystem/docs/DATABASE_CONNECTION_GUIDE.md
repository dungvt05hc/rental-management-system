...
{
  "ConnectionStrings": {
    "DefaultConnection": "Host=aws-0-ap-southeast-1.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.fpvgtejnkxkushmzkstu;Password=***REMOVED-DB-PASSWORD***;SSL Mode=Require;Trust Server Certificate=true;Pooling=true;Minimum Pool Size=0;Maximum Pool Size=100"
  }
}
```
...
export DATABASE_URL="Host=aws-0-ap-southeast-1.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.fpvgtejnkxkushmzkstu;Password=***REMOVED-DB-PASSWORD***;SSL Mode=Require;Trust Server Certificate=true;Pooling=true"
...
2. **Convert URI to Npgsql Format**:
   ...
   ```
   postgresql://postgres.fpvgtejnkxkushmzkstu:***REMOVED-DB-PASSWORD***@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres
   ```
   
   Convert to:
   ```
   Host=aws-0-ap-southeast-1.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.fpvgtejnkxkushmzkstu;Password=***REMOVED-DB-PASSWORD***;SSL Mode=Require;Trust Server Certificate=true;Pooling=true
   ```

3. **Set Environment Variable** (recommended):
   ```bash
   # For deployment platforms
   DATABASE_URL="Host=aws-0-ap-southeast-1.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.fpvgtejnkxkushmzkstu;Password=***REMOVED-DB-PASSWORD***;SSL Mode=Require;Trust Server Certificate=true;Pooling=true;Minimum Pool Size=0;Maximum Pool Size=100"
...
# For Supabase
psql "postgresql://postgres.fpvgtejnkxkushmzkstu:***REMOVED-DB-PASSWORD***@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?sslmode=require"
```
