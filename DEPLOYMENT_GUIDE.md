...
4. Copy the connection string:
   ...
   postgresql://postgres.fpvgtejnkxkushmzkstu:***REMOVED-DB-PASSWORD***@aws-1-ap-southeast-1.pooler.supabase.com:6543/postgres
   ```
...
3. **Add Environment Variables**
   ...
   DATABASE_URL=Host=db.fpvgtejnkxkushmzkstu.supabase.co;Port=5432;Database=postgres;Username=postgres;Password=***REMOVED-DB-PASSWORD***;SSL Mode=Require;Trust Server Certificate=true
