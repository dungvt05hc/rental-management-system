...
if [ "$choice" = "1" ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "   - Add: VITE_API_BASE_URL = https://rental-management-api-lfgedmy2ua-uc.a.run.app/api"
        echo ""
        echo "📝 Next steps:"
    ...
    echo "   - VITE_API_BASE_URL = https://rental-management-api-lfgedmy2ua-uc.a.run.app/api"
